...
function Banner3D(props) {
    ...
    return (
        <Canvas shadows id="fade-in2" camera={{
          position: [0, 0, 10],       
          rotation: [0, 0, 0]  }}
          defaultCamera={{
          near: 0.1,
          ...
          lookAt: [0, 0, 10]
                ...
                <pointLight position={[0, 10, 0]} intensity={1} />
                  <Float speed={1} intensity={1.5} rotationIntensity={2}>
                    <Line worldUnits points={points} color="black" lineWidth={0.3} rotation={[-.5, 0, 0]}/>
                    <Text color="black" fontSize={3} position={[0, 0, 0]} rotation={[-.5, 0, 0]} 
                    extrudeFactor={0.1}
                    bevelEnabled={true}
                    bevelThickness={0.03}
                    bevelSize={0.02}
